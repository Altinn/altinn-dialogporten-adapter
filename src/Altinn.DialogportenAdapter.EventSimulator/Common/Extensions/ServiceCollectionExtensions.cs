...
internal static class ServiceCollectionExtensions
{
    ...
    public static IHostApplicationBuilder ReplaceLocalDevelopmentResources(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services
            .RemoveAllImplementationTypes(typeof(AzureTableStartupLoader))
            .ReplaceTransient<IMigrationPartitionRepository, MockMigrationPartitionRepository>(opt.DisableAzureStorage);
